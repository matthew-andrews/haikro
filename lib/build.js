...
function getDependencies(opts) {
	return Promise.all([
		...
		.then(function(results) {
			...
			var nodeModules = (results[1] && results[1].dependencies ? Object.keys(results[1].dependencies) : [])
				.map(function(dependency) { return './node_modules/' + dependency + '/'; });
